...
type AllMappedModels = MaybeOrArrayOfMaybe<Agency | Organization | Role | User>
...
export type ResolversTypes = {
  ...
  ExpenditureCategory: ResolverTypeWrapper<Omit<ExpenditureCategory, 'Uploads'> & { Uploads: Array<Maybe<ResolversTypes['Upload']>> }>;
  InputTemplate: ResolverTypeWrapper<Omit<InputTemplate, 'reportingPeriods'> & { reportingPeriods: Array<Maybe<ResolversTypes['ReportingPeriod']>> }>;
  ...
  OutputTemplate: ResolverTypeWrapper<Omit<OutputTemplate, 'reportingPeriods'> & { reportingPeriods: Array<Maybe<ResolversTypes['ReportingPeriod']>> }>;
  Project: ResolverTypeWrapper<Omit<Project, 'agency' | 'organization' | 'originationPeriod'> & { agency: ResolversTypes['Agency'], organization: ResolversTypes['Organization'], originationPeriod: ResolversTypes['ReportingPeriod'] }>;
  Query: ResolverTypeWrapper<{}>;
  Redwood: ResolverTypeWrapper<Redwood>;
  ReportingPeriod: ResolverTypeWrapper<Omit<ReportingPeriod, 'certifiedBy' | 'inputTemplate' | 'outputTemplate'> & { certifiedBy: Maybe<ResolversTypes['User']>, inputTemplate: ResolversTypes['InputTemplate'], outputTemplate: ResolversTypes['OutputTemplate'] }>;
  ...
  Subrecipient: ResolverTypeWrapper<Omit<Subrecipient, 'certifiedBy' | 'organization' | 'originationUpload'> & { certifiedBy: Maybe<ResolversTypes['User']>, organization: ResolversTypes['Organization'], originationUpload: ResolversTypes['Upload'] }>;
  ...
  Upload: ResolverTypeWrapper<Omit<Upload, 'agency' | 'expenditureCategory' | 'organization' | 'reportingPeriod' | 'uploadedBy' | 'validations'> & { agency: ResolversTypes['Agency'], expenditureCategory: ResolversTypes['ExpenditureCategory'], organization: ResolversTypes['Organization'], reportingPeriod: ResolversTypes['ReportingPeriod'], uploadedBy: ResolversTypes['User'], validations: Array<Maybe<ResolversTypes['UploadValidation']>> }>;
  UploadValidation: ResolverTypeWrapper<Omit<UploadValidation, 'agency' | 'inputTemplate' | 'invalidatedBy' | 'organization' | 'upload' | 'validatedBy'> & { agency: ResolversTypes['Agency'], inputTemplate: ResolversTypes['InputTemplate'], invalidatedBy: Maybe<ResolversTypes['User']>, organization: ResolversTypes['Organization'], upload: ResolversTypes['Upload'], validatedBy: Maybe<ResolversTypes['User']> }>;
...
export type ResolversParentTypes = {
  ...
  ExpenditureCategory: Omit<ExpenditureCategory, 'Uploads'> & { Uploads: Array<Maybe<ResolversParentTypes['Upload']>> };
  InputTemplate: Omit<InputTemplate, 'reportingPeriods'> & { reportingPeriods: Array<Maybe<ResolversParentTypes['ReportingPeriod']>> };
  Int: Scalars['Int'];
  JSON: Scalars['JSON'];
  ...
  OutputTemplate: Omit<OutputTemplate, 'reportingPeriods'> & { reportingPeriods: Array<Maybe<ResolversParentTypes['ReportingPeriod']>> };
  Project: Omit<Project, 'agency' | 'organization' | 'originationPeriod'> & { agency: ResolversParentTypes['Agency'], organization: ResolversParentTypes['Organization'], originationPeriod: ResolversParentTypes['ReportingPeriod'] };
  Query: {};
  Redwood: Redwood;
  ReportingPeriod: Omit<ReportingPeriod, 'certifiedBy' | 'inputTemplate' | 'outputTemplate'> & { certifiedBy: Maybe<ResolversParentTypes['User']>, inputTemplate: ResolversParentTypes['InputTemplate'], outputTemplate: ResolversParentTypes['OutputTemplate'] };
  Role: MergePrismaWithSdlTypes<PrismaRole, MakeRelationsOptional<Role, AllMappedModels>, AllMappedModels>;
  String: Scalars['String'];
  Subrecipient: Omit<Subrecipient, 'certifiedBy' | 'organization' | 'originationUpload'> & { certifiedBy: Maybe<ResolversParentTypes['User']>, organization: ResolversParentTypes['Organization'], originationUpload: ResolversParentTypes['Upload'] };
  Time: Scalars['Time'];
  UpdateAgencyInput: UpdateAgencyInput;
  UpdateExpenditureCategoryInput: UpdateExpenditureCategoryInput;
  UpdateInputTemplateInput: UpdateInputTemplateInput;
  ...
  UpdateUploadValidationInput: UpdateUploadValidationInput;
  UpdateUserInput: UpdateUserInput;
  Upload: Omit<Upload, 'agency' | 'expenditureCategory' | 'organization' | 'reportingPeriod' | 'uploadedBy' | 'validations'> & { agency: ResolversParentTypes['Agency'], expenditureCategory: ResolversParentTypes['ExpenditureCategory'], organization: ResolversParentTypes['Organization'], reportingPeriod: ResolversParentTypes['ReportingPeriod'], uploadedBy: ResolversParentTypes['User'], validations: Array<Maybe<ResolversParentTypes['UploadValidation']>> };
  UploadValidation: Omit<UploadValidation, 'agency' | 'inputTemplate' | 'invalidatedBy' | 'organization' | 'upload' | 'validatedBy'> & { agency: ResolversParentTypes['Agency'], inputTemplate: ResolversParentTypes['InputTemplate'], invalidatedBy: Maybe<ResolversParentTypes['User']>, organization: ResolversParentTypes['Organization'], upload: ResolversParentTypes['Upload'], validatedBy: Maybe<ResolversParentTypes['User']> };

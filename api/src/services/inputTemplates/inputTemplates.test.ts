  ...
  scenario('creates a inputTemplate', async () => {
    const result = await createInputTemplate({
      input: {
        name: 'String',
        version: 'String',
        effectiveDate: '2023-12-05T14:45:25.758Z',
        rulesGeneratedAt: '2023-12-05T14:45:25.758Z',
        updatedAt: '2023-12-05T14:45:25.758Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.version).toEqual('String')
    expect(result.effectiveDate).toEqual(new Date('2023-12-05T14:45:25.758Z'))
    expect(result.rulesGeneratedAt).toEqual(
      new Date('2023-12-05T14:45:25.758Z')
    )
    expect(result.updatedAt).toEqual(new Date('2023-12-05T14:45:25.758Z'))
  })

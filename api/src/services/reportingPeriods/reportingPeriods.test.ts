...
describe('reportingPeriods', () => {
  ...
  scenario('creates a reportingPeriod', async (scenario: StandardScenario) => {
    const result = await createReportingPeriod({
      input: {
        name: 'String',
        startDate: '2023-12-05T14:45:54.500Z',
        endDate: '2023-12-05T14:45:54.500Z',
        ...
        updatedAt: '2023-12-05T14:45:54.500Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.startDate).toEqual(new Date('2023-12-05T14:45:54.500Z'))
    expect(result.endDate).toEqual(new Date('2023-12-05T14:45:54.500Z'))
    ...
    expect(result.updatedAt).toEqual(new Date('2023-12-05T14:45:54.500Z'))
  })

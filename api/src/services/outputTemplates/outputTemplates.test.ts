  ...
  scenario('creates a outputTemplate', async () => {
    const result = await createOutputTemplate({
      input: {
        name: 'String',
        version: 'String',
        effectiveDate: '2023-12-05T14:45:43.906Z',
        rulesGeneratedAt: '2023-12-05T14:45:43.906Z',
        updatedAt: '2023-12-05T14:45:43.906Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.version).toEqual('String')
    expect(result.effectiveDate).toEqual(new Date('2023-12-05T14:45:43.906Z'))
    expect(result.rulesGeneratedAt).toEqual(
      new Date('2023-12-05T14:45:43.906Z')
    )
    expect(result.updatedAt).toEqual(new Date('2023-12-05T14:45:43.906Z'))
  })

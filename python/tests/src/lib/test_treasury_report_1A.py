...
class TestGenerateOutput1A:
    def test_get_projects_to_remove(self, valid_workbook_1A):
    ...
    def test_combine_project_rows(self, valid_workbook_1A):
    ...
    def test_combine_project_rows_with_conflicts_1(
        self, valid_workbook_1A, valid_workbook_1A_with_conflict
    ):
    ...
    def test_combine_project_rows_multiple(
        self, valid_workbook_1A, valid_second_workbook_1A_sheet
    ):
        """Choose the project with the later created at date"""
        project_id_agency_id_to_upload_date = {}
        project_id_agency_id_to_row_num = {}

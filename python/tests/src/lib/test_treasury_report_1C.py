...
class TestGenerateOutput1C:
    def test_get_projects_to_remove(self, valid_workbook_1C: Workbook) -> None:
    ...
    def test_combine_project_rows(self, valid_workbook_1C: Workbook) -> None:
    ...
    def test_combine_project_rows_with_conflicts_1(
        self, valid_workbook_1C: Workbook, valid_workbook_1C_with_conflict: Workbook
    ) -> None:
    ...
    def test_combine_project_rows_multiple(
        self, valid_workbook_1C: Workbook, valid_second_workbook_1C_sheet: Workbook
    ) -> None:
        """Choose the project with the later created at date"""
        project_id_agency_id_to_upload_date: dict[str, datetime] = {}
        project_id_agency_id_to_row_num: dict[str, int] = {}

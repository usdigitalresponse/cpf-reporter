...
class TestGenerateOutput1B:
    def test_get_projects_to_remove(self, valid_workbook_1B: Workbook) -> None:
    ...
    def test_combine_project_rows(self, valid_workbook_1B: Workbook) -> None:
    ...
    def test_combine_project_rows_with_conflicts_1(
        self, valid_workbook_1B: Workbook, valid_workbook_1B_with_conflict: Workbook
    ) -> None:
    ...
    def test_combine_project_rows_multiple(
        self, valid_workbook_1B: Workbook, valid_second_workbook_1B_sheet: Workbook
    ) -> None:
        """Choose the project with the later created at date"""
        project_id_agency_id_to_upload_date: dict[str, datetime] = {}
        project_id_agency_id_to_row_num: dict[str, int] = {}
